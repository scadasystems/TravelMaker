...
<body>
  ...
  <div class="container">
    <div class="text" style="margin-left:0; margin-top:50px">
      <!-- text animation -->
      <!-- End text animation -->
      <p style="margin-left:0">Best Airline </p>
      <p style="margin-left:0;">15</p>
      <p style="margin-left:0">'In The World</p>
    </div>
    <div id="item-list">
      <ul>
        <li>
          ...
          <div class="detail" style="display: block">
            <div class="blog-card alt">
              ...
              <div class="description">
                <h1>"역사만큼 깊은 수준"</h1>
                <h2>4.9 <i class="fa fa-heart"></i></h2>
        ...
        <li>
          ...
          <div class="detail">
            <div class="blog-card alt">
              ...
              <div class="description">
                <h1>"생의 최고의 항공사"</h1>
                <h2>4.8 <i class="fa fa-heart"></i></h2>
        ...
        <li>
          ...
          <div class="detail">
            <div class="blog-card alt">
              ...
              <div class="description">
                <h1>"깔끔하며 친절한 항공사"</h1>
                <h2>4.7 <i class="fa fa-heart"></i></h2>
