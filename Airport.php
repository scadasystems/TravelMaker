          ...
          <div class="detail" style="display: block">
            <div class="blog-card alt">
              ...
              <div class="description">
                <h1>한줄평</h1>
                <h2>4.9</h2>
                <p>항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공!사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 항공사소개 </p>
                <p class="read-more">
